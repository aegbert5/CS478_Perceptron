...
public abstract class SupervisedLearner {
  ...
  // Some learning algorithms need to define their stopping criteria based on how the algorithm performs on the validation data set, which will be overriden
